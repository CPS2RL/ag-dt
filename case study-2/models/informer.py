...
@register_keras_serializable()
class TimeSeriesInformerRegression(Model):
    def __init__(self, 
                 num_layers,
                 d_model,
                 num_heads,
...
def create_informer_model(sequence_length, num_features, num_layers=4, d_model=128, 
                         num_heads=8, dff=256, dropout_rate=0.1, factor=5, 
                         learning_rate=0.001):

    model = TimeSeriesInformerRegression(
